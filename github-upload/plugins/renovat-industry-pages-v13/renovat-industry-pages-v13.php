...
function rip_header($title, $description, $canonical, $keywords = '') {
    return '<!doctype html><html lang="ja"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">' .
        '<title>' . esc_html($title) . '</title><meta name="description" content="' . esc_attr($description) . '">' .
        ...
        '<meta property="og:type" content="article"><meta property="og:title" content="' . esc_attr($title) . '"><meta property="og:description" content="' . esc_attr($description) . '"><meta property="og:url" content="' . esc_url($canonical) . '">' .
        '<style>' . rip_css() . '</style></head><body><header class="rip-header"><div class="rip-wrap rip-head"><a class="rip-logo" href="/">RENOVAT</a><nav><a href="/">トップ</a><a href="/industry/">業種別</a><a href="/business-waste.html">事業系ごみ</a><a href="/area.html">対応エリア</a><a href="/contact.html#form">無料相談</a></nav></div></header>';
}
